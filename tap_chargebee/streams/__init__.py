...
AVAILABLE_STREAMS_1_0_ONLY = [AddonsStream, PlansStream]

AVAILABLE_STREAMS_2_0_ONLY = [ItemsStream, ItemPricesStream]
...
AVAILABLE_STREAMS_ALL = (
    AVAILABLE_STREAMS + AVAILABLE_STREAMS_1_0_ONLY + AVAILABLE_STREAMS_2_0_ONLY
)
